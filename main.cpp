...
int64 nChainStartTime = 1498007450;
...
const string strMessageMagic = "Litechain Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    else if(nHeight > 100 && nHeight <= 525700)
    {
        nSubsidy = 50 * COIN;
    }
    else if(nHeight > 525700 && nHeight <= 1051300)
    {
        nSubsidy = 25 * COIN;
    }
    else if(nHeight > 1051300 && nHeight <= 1576900)
    {
        nSubsidy = 12.5 * COIN;
    }
    else if(nHeight > 1576900 && nHeight <= 2102500)
    {
        nSubsidy = 6.25 * COIN;
    }
    else if(nHeight > 2102500 && nHeight <= 2628100)
    {
        nSubsidy = 3.125 * COIN;
    }
    else if(nHeight > 2628100 )
   {
       nSubsidy = 0 * COIN;
   }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Litechain
    bool fStrictPayToScriptHash = true; // Always active in Litechain
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Litechain", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum vector Litechain empty mapBlockIndex Litechain Litechain";
        CTransaction txNew;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0xab1d460309255b4044bee4ec011be31112915d2a829b146d648c2231e4beb8da"));
